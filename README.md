...
- **The model explains most of the variation it sees.** Test R² **0.848** (train 0.869 — a small **0.020** gap, so it generalises rather than memorises). Typical miss is **₹47,100/month** (MAE); RMSE is ₹109,200, dragged up by a few large misses.

## Where it breaks (the honest part)

The model is reliable for typical mid-tier 1–2 BHK flats and **unreliable at the luxury tail and in thin localities**. Its worst prediction: a 6BHK in Versova listed at ₹4,00,000 that the model priced at ₹9,21,000 — because it had almost no other 6BHKs to learn from and reached toward the mean of a sparse, high-variance group. Full failure analysis in `docs/model_report.md`; honest limits in `docs/limitations.md`.
