...
Rent in Mumbai is driven first by **locality**, then by **size**, with a modest, real **metro premium** on top. A one-model baseline predicts rent within a typical **±₹44,000/month** and explains about **77%** of the variation (cross-validated R² 0.77 ± 0.05 — tight across folds). It is trustworthy for mid-tier 1–2 BHK flats — the bulk of the market — and unreliable for luxury and rare configurations. **Use it to triage listings, not to auto-price the top end.**
...
|---|---|---|---|
| Santacruz West 8BHK | ₹8.0L | ~₹1.27Cr | Lone 8BHK — model extrapolates wildly, **trust the listing** |
| Andheri West 6BHK | ₹9.0L | ₹19.3L | Luxury tail, thin signal — **human check** |
| Malad West 6BHK | ₹7.0L | ₹14.0L | Rare 6BHK config, thin signal — **human check** |
| Lower Parel 3BHK | ₹4.0L | ₹7.8L | Premium 3BHK, model over-reaches — **human check** |
| Pali Hill 4BHK | ₹6.0L | ₹2.6L | Solo locality → city-median fallback **under**-prices it — **human check** |
...
1. **Deploy the model as a triage filter now** for 1–3 BHK flats in localities with ≥5 listings — auto-flag anything more than ±₹44k off the prediction for review. Low risk, immediate value.
